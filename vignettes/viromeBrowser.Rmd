...
In the Annotation Files tab it is necessary to select the columns in the uploaded annotation files that correspond to the respective annotation values used by the app. You can click the dropdown fields in the table and select which column should be used for which annotation value. If your annotation data does not contain the a specific value leave it on "NotAvailable". (For the example data you do not have to specify these columns)
